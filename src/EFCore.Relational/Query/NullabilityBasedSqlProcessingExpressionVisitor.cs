...
namespace Microsoft.EntityFrameworkCore.Query
{
    public class NullabilityBasedSqlProcessingExpressionVisitor : SqlExpressionVisitor
    {
        ...
        /// <param name="allowOptimizedExpansion">True if null semantics inside the expression can be expanded in the optimized way (i.e. <see langword="null"/> and <see langword="false"/> are interchangable), false otherwise. </param>
